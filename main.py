...
def collect_data(city_code='2706'):
    ...
    for card in cards:
        ...
        card_price_old_integer = card.find('div', class_='label__price_old'). \
            find('span', class_='label__price-integer').text.strip()
        card_price_old_decimal = card.find('div', class_='label__price_old'). \
            find('span', class_='label__price-decimal').text.strip()
        card_price_old = f'{card_price_old_integer}.{card_price_old_decimal}'

        card_price_integer = card.find('div', class_='label__price_new'). \
            find('span', class_='label__price-integer').text.strip()
        card_price_decimal = card.find('div', class_='label__price_new'). \
            find('span', class_='label__price-decimal').text.strip()
        ...
        print(f'{city}_{cur_time}.csv успешно создан!')


def main():
    collect_data(city_code='2706')
